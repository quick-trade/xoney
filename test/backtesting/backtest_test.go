...
func TestMain(m *testing.M) {
	...
	chart, err := dtr.LoadChartFromCSV("/home/vlad/Desktop/development/quick_trade/dataframes/BTCUSDT15m.csv")
	if err != nil {
		panic(err)
	}
...
func TestBacktestReturnsEquity(t *testing.T) {
	...
	var system st.Tradable = testdata.NewBBStrategy(80, 1.5, instrument)
